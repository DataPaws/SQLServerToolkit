...
DECLARE @TargetDatabaseName NVARCHAR(128) = '',
        @SQL VARCHAR (8000), 
        @log_reuse_wait tinyint, 
        @log_reuse_wait_desc nvarchar(120), 
        @dbname sysname, 
        @database_id int, 
        @recovery_model_desc varchar (24)
...
BEGIN
    RAISERROR('No target database was specified', 18, 1) WITH NOWAIT;
END
